...
const POLICY_VALIDATORS = {
	...
	"system.grid_auto_save_layouts": (value) => {
		...
		if (typeof value !== "boolean") {
			return {
				valid: false,
				message: "system.grid_auto_save_layouts must be boolean",
			};
		}
		return { valid: true };
	},
	"system.grid_save_feedback": (value) => {
		...
		if (typeof value !== "boolean") {
			return {
				valid: false,
				message: "system.grid_save_feedback must be boolean",
			};
		}
		return { valid: true };
	},
	"system.grid_ai_suggestions": (value) => {
		...
		if (typeof value !== "boolean") {
			return {
				valid: false,
				message: "system.grid_ai_suggestions must be boolean",
			};
		}
		return { valid: true };
	},
	"system.grid_auto_save_layout_id": (value) => {
		if (typeof value !== "string" || value.trim().length === 0) {
			return {
				valid: false,
				message:
					"system.grid_auto_save_layout_id must be a non-empty string",
			};
		}
		return { valid: true };
	},
	"system.grid_auto_save_layout_scope": (value) => {
		...
		if (typeof value !== "string") {
			return {
				valid: false,
				message: "system.grid_auto_save_layout_scope must be a string",
			};
		}
	...
	"grid.enable_analytics": (value) => {
		...
		if (typeof value !== "boolean") {
			return {
				valid: false,
				message: "grid.enable_analytics must be boolean",
			};
		}
		return { valid: true };
	},
	...
	"grid.allowed_component_types": (value) => {
		if (!Array.isArray(value)) {
			return {
				valid: false,
				message:
					"grid.allowed_component_types must be an array of strings",
			};
		}
		if (value.some((v) => typeof v !== "string" || !v.trim())) {
			return {
				valid: false,
				message:
					"grid.allowed_component_types entries must be non-empty strings",
			};
		}
		return { valid: true };
	},
	...
	"grid.default_columns": (value) => {
		if (!Number.isInteger(value) || value < 1 || value > 96) {
			return {
				valid: false,
				message:
					"grid.default_columns must be an integer between 1 and 96",
			};
		}
		return { valid: true };
	},
	"grid.default_min_w": (value) => {
		if (!Number.isInteger(value) || value < 1) {
			return {
				valid: false,
				message: "grid.default_min_w must be a positive integer",
			};
		}
		return { valid: true };
	},
	"grid.default_min_h": (value) => {
		if (!Number.isInteger(value) || value < 1) {
			return {
				valid: false,
				message: "grid.default_min_h must be a positive integer",
			};
		}
		return { valid: true };
	},
	"grid.default_max_w": (value, ctx) => {
		if (!Number.isInteger(value) || value < 1) {
			return {
				valid: false,
				message: "grid.default_max_w must be a positive integer",
			};
		}
		return { valid: true };
	},
	"grid.default_max_h": (value) => {
		if (!Number.isInteger(value) || value < 1) {
			return {
				valid: false,
				message: "grid.default_max_h must be a positive integer",
			};
		}
		return { valid: true };
	},
